	...
	public Toolbox() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ev) {
				int x_value = x.getText().equals("") ? 0 : Integer.parseInt(x.getText());
				int y_value = y.getText().equals("") ? 0 : Integer.parseInt(y.getText());
				int width_value = width.getText().equals("") ? 0 : Integer.parseInt(width.getText());
				int height_value = height.getText().equals("") ? 0 : Integer.parseInt(height.getText());
				int red_value = red.getText().equals("") ? 1 : Integer.parseInt(red.getText());
				int green_value = green.getText().equals("") ? 1 : Integer.parseInt(green.getText());
				int blue_value = blue.getText().equals("") ? 1 : Integer.parseInt(blue.getText());
				
				if (button1.isSelected()) {
					PictureEditor.printPixelColors(x_value, y_value);
				} else if (button2.isSelected()) {
					PictureEditor.color = new Color(red_value, green_value, blue_value);
					PictureEditor.drawDarkerLine(y_value, width_value);
				} else if (button3.isSelected()) {
					PictureEditor.color = new Color(red_value, green_value, blue_value);
					PictureEditor.drawSquare(x_value, y_value, width_value, height_value);
				} else if (button4.isSelected()) {
					PictureEditor.color = new Color(red_value, green_value, blue_value);
					PictureEditor.drawTriangle(x_value, y_value, height_value);
